...
//
//document.getElementById("netIncomeButton").addEventListener("click",
//
//                                                            
//                                                            
//                                                            
...
// client = genClientPropertyValue();
//    resourceEligibility = resourceEligibiliyCheck(client);
//    grossIncomeEligibility = grossIncomeEligibilityCheck(client);
//    netIncomeDeductionSumGenerate();
//    shelterDeductionSumGenerate(); 
//    shelterDeductionLimitGenerate(); 
//    netIncomeValueGenerate();
//    netIncomeEligibility = netIncomeEligibilityCheck(client);
